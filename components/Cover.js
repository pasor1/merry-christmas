    ...
    return (
      <>
        <div className="coverContainer">
          <Particles /* className={this.state.started ? null : "hidden"} */
            options={{
              "autoPlay": true,
              "background": {
                "color": {
          ...
          <div className="coverContentContainer">
            <div className={this.state.started ? "coverMerry" : "hidden"}>
              <img src="/Merry.svg" />
            </div>
            <div className={this.state.started ? "coverChristmas" : "hidden"}>
          ...
          <div className={this.state.started ? "clickedMe" : "clickMe"} onClick={this.startPlayHandler}>
            <img src="/candy.png" style={{ width: "300px" }} />
